...
export const siteConfig: SiteConfig = {
	...
	description:
		"真正改变世界的并不是某一个具体的工具，而是不断进化的认知与持续行动的能力。</br></br>这里记录自己关于人工智能、量化交易、阅读思考与创业实践的探索历程。</br>我将这里视为自己的数字实验室与知识花园：记录问题，验证假设，沉淀经验，分享发现。</br>希望多年以后回望，这些文字不仅见证了技术浪潮的变迁，也记录了一名终身学习者持续成长的轨迹。</br><b>Build. Learn. Think. Repeat.</b></br><b>构建、学习、思考，然后再次出发</b>",
	lang: "zh_CN",
	ogLocale: "zh_CN",
